...
logdata = True
playback_from = 4800.0  # seconds to start playback from
...
logistic_filter_midpoint = 20.  # midpoint of the logistic weight function for inhibiting velocity based on heading
